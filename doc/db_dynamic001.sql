...
MySQL - 5.7.18-log : Database - db_dynamic001
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_dynamic001` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `db_dynamic001`;

/*Table structure for table `dynamic001_sys_dict_type` */

DROP TABLE IF EXISTS `dynamic001_sys_dict_type`;

CREATE TABLE `dynamic001_sys_dict_type` (
